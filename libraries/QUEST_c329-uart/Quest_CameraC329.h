#ifndef Quest_CAMERAC329_H_
#define Quest_CAMERAC329_H_
...
#define RESPONSE_DELAY 100  //was 100

// Size (in bytes) to split up picture data into packages for processing
#define DEFAULT_PACKAGE_SIZE 128

#define C329serial Serial1  //*****************************Serial port for uart camera *********************

class Quest_CameraC329
{
  public:
    enum BaudRate
    {
