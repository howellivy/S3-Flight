 ...
 *   20220627 pcf85263 added by hai 
 * 
 * *************************************************************************
 * *************************************************************************
 * 
...
#ifndef _Quest_RTCLIB_H_
#define _Quest_RTCLIB_H_
...
/**************************************************************************/
/*!
    @brief  RTC based on the pcf85263 chip connected via I2C and the Wire library
*/
/**************************************************************************/

class RTC_pcf85263 : RTC_I2C {
public:
  boolean begin(TwoWire *wireInstance = &Wire);
