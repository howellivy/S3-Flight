...
Serial.println("Test of Que, files added to Que");
  // Add files to queue
    addFileToQueue("HI00000.txtLL"); 
    addFileToQueue("HI00001.txtLL"); 
    addFileToQueue("HI00002.txtLL"); 
    addFileToQueue("HI00003.txtLL");
    addFileToQueue("HI00004.txtLL");
    addFileToQueue("HI00005.txtLL"); 
    addFileToQueue("HI00006.txtLL"); 
    addFileToQueue("HI00007.txtLL"); 
    addFileToQueue("HI00008.txtLL");
    addFileToQueue("HI00009.txtLL");
    //
    addFileToQueue("HI00000.txtLL"); 
    addFileToQueue("HI00001.txtLL"); 
    addFileToQueue("HI00002.txtLL"); 
